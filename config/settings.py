...
# SECRET_KEY = 'django-insecure-77$dxj$u_^5p)8k6e2=2wplor3i8#6v%i3k#%n_rjll0*$8b1p'
...
CONTACT_RECIPIENT_EMAIL = os.getenv('CONTACT_RECIPIENT_EMAIL', os.getenv('EMAIL_HOST_USER', ''))
